...
User.create!(email: "admin@gmail.com", password: "password", name: "Ty", role: 2)
User.create!(email: "user@gmail.com", password: "password", name: "Ty", role: 1)
megan.users.create!(email: "merchant_admin@gmail.com", password: "password", name: "Tay", role: 1)
megan.users.create!(email: "merchant_user@gmail.com", password: "password", name: "Tay", role: 1)

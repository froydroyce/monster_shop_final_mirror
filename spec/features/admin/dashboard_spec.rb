...
RSpec.describe 'Admin Dashboard' do
  describe 'As an Admin' do
    before :each do
      ...
      @m_user_address = @m_user.addresses.create!(address_name: "Home", address: "1234 Main st", city: "Denver", state: "CO", zip: 80229)
      ...
      @order_1 = @m_user.orders.create!(address_id: @m_user_address.id, status: "packaged")
      @order_2 = @m_user.orders.create!(address_id: @m_user_address.id,status: "pending")
      @order_3 = @m_user.orders.create!(address_id: @m_user_address.id,status: "cancelled")
